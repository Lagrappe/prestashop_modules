<div id="crmcycles-store-trial"
  ...
  <div class="crmcycles-trial-form-wrapper" id="crmcycles-trial-form-wrapper" style="display:none;">
    <form id="crmcycles-trial-form" class="crmcycles-trial-form" novalidate>
      ...
      <div class="form-group">
        ...
        <input type="text" id="trial_lastname" name="trial_lastname" class="form-control" required>
      </div>

      <div class="form-group">
        <label for="trial_firstname">Prénom <span class="required">*</span></label>
        <input type="text" id="trial_firstname" name="trial_firstname" class="form-control" required>
      </div>

      <div class="form-group">
        <label for="trial_email">Email <span class="required">*</span></label>
        <input type="email" id="trial_email" name="trial_email" class="form-control" required>
      </div>

      <div class="form-group">
        <label for="trial_phone">Téléphone <span class="required">*</span></label>
        <input type="tel" id="trial_phone" name="trial_phone" class="form-control" required>
      </div>
      ...
      <div class="crmcycles-trial-actions">
        <button type="submit" class="btn btn-primary" id="crmcycles-trial-submit">
          Envoyer ma demande
        </button>
